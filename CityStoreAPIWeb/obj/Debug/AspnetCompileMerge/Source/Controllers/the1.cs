...
{
    public class the1Controller : ApiController
    {
      ...
      public HttpResponseMessage DCart(deletecart obj)
        ...
        //    if (Exid == 0)
        //    {
        //        var Results = (from p in db.products select new Productinfolist { productid = p.productid, productname = p.productname, categoryid = p.categoryid, Image = p.image }).OrderByDescending(x => x.productid).Take(16);
        //        List<Productinfolist> list_cart = Results.ToList<Productinfolist>();
